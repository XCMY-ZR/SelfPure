...
def parser_train():
    ...
    parser.add_argument('--data-dir', type=str, default='/share/home/yyman/data/')
    parser.add_argument('--log-dir', type=str, default='/share/home/yyman/ARP-frame/log/')
    ...
    parser.add_argument('--aux-data-filename', type=str, help='Path to additional Tiny Images data.', 
                        default='/share/zhangrui/data/cifar10s/cifar10_ddpm.npz')
